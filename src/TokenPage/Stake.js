        ...
        <div className="bg-lightGray dark:bg-slate-800 p-4 rounded-xl flex flex-col">
          <div className="flex-grow">
            ...
            <p className="dark:text-gray-400">
              ...
              vesting period and claim tokens immediately for a 50% fee that is
              paid to users who lock PANIC.
            </p>
            <h5 className="text-md font-display mt-3 mb-1 dark:text-blue-300">
              Locked (& Staked) PANIC
            </h5>
            ...
            <p className="dark:text-gray-400">
              ...
              unlocked early. You will continue to earn fees after the locks
