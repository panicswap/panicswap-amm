...
function CoinSwapper(props) {
  ...
  return (
    <div className="px-2 mt-5 md:mt-14">
      <WrongNetwork open={wrongNetworkOpen} />
      <div className="max-w-md mx-auto bg-blue-100 bg-gradient-to-bl from-blue-300 to-blue-100 dark:bg-slate-800 dark:bg-gradient-to-tr dark:from-transparent dark:to-transparent rounded-2xl p-3 shadow-lg">
