...
function App() {
  ...
  try {
    ...
    return (
      <div className="flex flex-col min-h-screen App bg-gradient-to-bl from-blue-300 via-blue-100  to-blue-50 dark:bg-slate-900 dark:from-transparent dark:to-transparent">
